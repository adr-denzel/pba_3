...
months_on_book = st.sidebar.slider('Months on Book:', min_value=0, max_value=60, value=0)
...
credit_limit = st.sidebar.slider('Credit Limit:', min_value=1000, max_value=35000, value=1000)
total_revolving_balance = st.sidebar.slider('Card Balance:', min_value=0, max_value=35000, value=1000)
total_trans_amount = st.sidebar.slider('Total Transactions Value:', min_value=0, max_value=35000, value=5000)
